...
// ── Sport Presets ──
const SPORTS = {
  cricket:    { name: 'Cricket Pro Spike Sole',       emoji: '🏏', upper: '#1A1A2E', laces: '#FFFFFF', price: 1000 },
  football:   { name: 'Football Velocity Sole',       emoji: '⚽', upper: '#0057FF', laces: '#FFFFFF', price: 1000 },
  running:    { name: 'Running Aero Cushion Sole',   emoji: '🏃', upper: '#E91E63', laces: '#FFFFFF', price: 1000 },
  gym:        { name: 'Gym & Training Flex Sole',    emoji: '🏋️', upper: '#3F51B5', laces: '#FFFFFF', price: 1050 },
  volleyball: { name: 'Volleyball Spike Grip Sole',   emoji: '🏐', upper: '#00D4FF', laces: '#FFFFFF', price: 1100 },
  badminton:  { name: 'Badminton Smash Court Sole',   emoji: '🏸', upper: '#00C853', laces: '#FFFFFF', price: 1150 },
  basketball: { name: 'Basketball Dominator Sole',   emoji: '🏀', upper: '#FF6B2B', laces: '#000000', price: 1200 },
  tennis:     { name: 'Tennis Court Master Sole',    emoji: '🎾', upper: '#9C27B0', laces: '#FFD700', price: 1200 }
};

const MODEL_URL = 'models/main-shoe.glb';
const BASE_PRICE = 1500;
const SOLE_PRICE = 1000;
